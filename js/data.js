...
export const itinerary = [
  {
    ...
    schedule: [
      ...
      { time: '14:30', tag: 'hotel', title: '入住 + 午休', desc: '五一广场商圈酒店安顿行李，小睡一会避开正午暑气——舒适第一，今天不赶路。' },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: '17:00', tag: 'transport', title: '抵达张家界', desc: '打车约 15 分钟入住市区酒店，选在天门山索道站附近，后天出发更从容。' },
  ...
  },
  {
    ...
    subtitle: '玻璃栈道牵手走过，999 级台阶丈量天空，傍晚高铁回星城',
    ...
    schedule: [
      ...
      { time: '08:40', tag: 'sight', title: '西线玻璃栈道', desc: '鞋套 ¥5/人，悬空于千米崖壁之上，恐高的那个请抓紧另一半的手。' },
      ...
      { time: '19:30', tag: 'hotel', title: '抵达长沙 · 入住', desc: '住长沙南站或磁浮沿线酒店，明天去机场最从容；附近简餐后早点休息。' }
    ],
    transport: '天门山 A 线 ¥278/人 · 张家界西 → 长沙南高铁 ¥180/人',
    hotel: '长沙 · 长沙南站/磁浮沿线酒店',
    tip: '山顶风大温低，备一件薄外套；回程高铁建议买 16:30 之后的班次，天门山玩完不赶不慌。'
  },
  {
...
export const budget = {
  ...
  items: [
    ...
    { name: '住宿 6 晚', amount: 2400, icon: 'ri-hotel-bed-line', color: '#8b5cf6', desc: '均价 ¥400/晚，商圈与索道站地段' },
...
export const tips = [
  ...
  },
  {
    ...
    desc: '橘子洲黄昏逆光剪影绝美；爱晚亭上午光线最柔；金鞭溪正午溪水透亮；天门山上午顺光且云雾多。'
  },
  {
